# -*- coding: utf-8 -*-
"""
Created on Mon May  9 10:15:37 2022
...
def DNN_training_base_topology(X_train, X_val, y_train, y_val, x, y):
    ...
    elapsed_time
    model.save_weights("D:\Hritik\Saved_models\Base_TF_weights_11.h5")
    model.save("D:\Hritik\Saved_models\Base_topology_DNN_TF_11.h5")
    return(model)
