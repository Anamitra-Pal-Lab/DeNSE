...
def Load_Testing_Transfer_Learning_Data(filepath, n):
    ...
    df_If_ang = pd.read_csv(filepath+('If_ang_test_T'+str(n)+'_12am.csv'), header = None)
    df_If_mag= pd.read_csv(filepath+('If_mag_test_T'+str(n)+'_12am.csv'), header = None)
    df_It_ang= pd.read_csv(filepath+('It_ang_test_T'+str(n)+'_12am.csv'), header = None)
    df_It_mag= pd.read_csv(filepath+('It_mag_test_T'+str(n)+'_12am.csv'), header = None)
    df_VDATA_mag = pd.read_csv(filepath+('VDATA_mag_test_T'+str(n)+'_12am.csv'), header = None)
    df_VDATA_ang = pd.read_csv(filepath+('VDATA_ang_test_T'+str(n)+'_12am.csv'), header = None)
